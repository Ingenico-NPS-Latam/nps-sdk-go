...
func SendPayOnLine_2p(service *npsSdk.PaymentServicePlatformPortType) error {
        ...
        SellerDetails.EmailAddress = "selleremail@email.com"
        SellerDetails.PhoneNumber1 = "1234-2223"
...
func SendBankPayment_2p(service *npsSdk.PaymentServicePlatformPortType) error {
        ...
        tax2 := npsSdk.NewTaxesRequestStruct()
        tax2.TypeId = "100"
        tax2.Amount = "10"
        tax2.Rate = "50"

        Taxes.Items = append(Taxes.Items, tax2)
...
func SendCreateCustomer(service *npsSdk.PaymentServicePlatformPortType) error {
        ...
        pm.PaymentMethodToken = "pm-token_lCY303k0vHvS5W06sPwzgoSHNt0VRrkG"
